        ...
        <Tab
          ...
          title={
            <span className={activeTab === 'home' ? 'active-tab' : ''}>
              1.Promote Services and Attract Local Clients
            </span>
          }
        >
          <div className="content">
            <div className="text-section">
              <h3>Promote Services and Attract Local Clients</h3>
              <ul>
                <li>
                  <div className='arrow-wrap'>
                    <img src='lic.svg'/>
                    <p>Showcase your business with tailored offers for haircuts, spa treatments, skincare services, fitness classes, and more..</p>
                  </div>
                </li>
                <li>
                <div className='arrow-wrap'>
                <img src='lic.svg'/>
                  <p>Create promotions that fill slow days, such as, Midweek Spa Discounts, First-Time Client Specials, Seasonal Beauty Packages</p>
                </div>
                </li>
              </ul>
            </div>
