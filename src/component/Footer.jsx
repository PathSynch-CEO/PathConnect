...
<div class="footer-section">
  ...
  <div class="footer-logo">
    ...
    <ul class="solutions">
      ...
      <li>Cashback</li>
      <li>Memberships</li><li>Loyalty Programs</li>
     <li> <Link to="/refer-friend">Referrals</Link></li>
    </ul>
    <ul class="resources">
    <h5>Resources</h5>
      ...
      <li>Case Studies</li>
      <li>Help Center</li>
      <Link to="/request-demo"><li>Demo Request</li></Link>
      <Link to="/becomepartner"><li>Become Partner</li></Link>
    </ul>
    <ul class="company">
    <h5>Company</h5>
    <Link to="/aboutus"> <li>About Us</li></Link>
      ...
      <Link to="/terms-of-use"><li>Terms and Conditions</li></Link>
    </ul>
  </div>
